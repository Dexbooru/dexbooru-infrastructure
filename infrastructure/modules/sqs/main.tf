...
locals {
  ...
  max_anime_series_classification_visible_time_seconds           = 90    # 1.5 minutes
...
resource "aws_sqs_queue" "anime_series_classification_queue" {
  ...
  visibility_timeout_seconds = local.max_anime_series_classification_visible_time_seconds
